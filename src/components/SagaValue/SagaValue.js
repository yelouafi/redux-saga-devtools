...
export default function SagaValue({value, label, isIdentifier, highlighted = false}) {
  if(is.channel(value)) {
    ...
    return <JSValue value={value} label={label} isIdentifier={isIdentifier} renderRaw={highlighted} />
  }
}
